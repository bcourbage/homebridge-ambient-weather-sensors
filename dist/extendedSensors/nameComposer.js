 ...
 */
export function sanitizeForTileName(input) {
    return input
 ...
 */
export function composeStaticName(sensorLabel) {
 ...
 */
export function composeEmbeddedName(sensorLabel, valueStr) {
 ...
 */
export function isUserRenamed(currentName, lastSetName) {
    if (!currentName || !lastSetName) {
        return false;
    }
    return currentName !== lastSetName;
}
//# sourceMappingURL=nameComposer.js.map