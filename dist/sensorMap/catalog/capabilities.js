...
export const NATIVE_SENSOR_SERVICES = [
    ...
    { service: 'MotionSensor', kinds: ['motion'], status: 'implemented-narrow',
        pairs: [
            ...
            { pair: 'motion|numeric', wrapperId: 'numeric', since: 4 },
        ],
        scope: 'The weather-value/threshold shell (extended representation): a numeric measurement with an optional threshold trigger. Catalog 3 adds the DIRECT boolean mapping (motion|boolean, §19.1) and the agronomic/AQI numeric measurements (§19.4). Catalog 4 adds the generic numeric passthrough (motion|numeric, §19.9): a finite reading with a literal unit label and an optional inclusive-level threshold, no invented conversion. Custom pairs resolve the most generic wrapper of each measurement; sub-flavors ride known dataPoints.' },
