...
export declare const LEGAL_UNITS_FOR_MEASUREMENT: Readonly<Record<Measurement, ReadonlyArray<SensorUnit>>>;
/**
 ...
 * illuminance sensors.
 */
export declare const DEFAULT_SOURCE_UNIT_FOR_MEASUREMENT: Readonly<Partial<Record<Measurement, SensorUnit>>>;
/**
 ...
 */
export declare const DEFAULT_DISPLAY_UNIT_FOR_MEASUREMENT: Readonly<Partial<Record<Measurement, SensorUnit>>>;
/**
 * Check whether a unit is legal for a given measurement.
 */
export declare function isLegalUnit(measurement: Measurement, unit: SensorUnit): boolean;
/**
 ...
 */
export declare const COMPATIBLE_KINDS_FOR_MEASUREMENT: Readonly<Record<Measurement, ReadonlyArray<Exclude<import('./types.js').SensorKind, 'unrecognized'>>>>;
export declare function isCompatibleKind(measurement: Measurement, kind: Exclude<import('./types.js').SensorKind, 'unrecognized'>): boolean;
