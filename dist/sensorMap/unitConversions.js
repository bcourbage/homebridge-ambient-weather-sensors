 ...
 */
export const CANONICAL_UNIT_FOR_MEASUREMENT = {
    'temperature': 'celsius',
    'humidity': 'percent',
    'illuminance': 'lux',
    'co2': 'ppm',
 ...
 * is already 0/1).
 */
export function toCanonical(measurement, sourceUnit, value) {
    switch (measurement) {
        case 'temperature':
 ...
 */
export function toDisplayUnit(measurement, canonical, displayUnit) {
    switch (measurement) {
        case 'temperature':
        ...
        case 'pressure':
            return convertPressure(canonical, displayUnit);
        case 'distance':
            return convertDistance(canonical, displayUnit);
        default:
            return canonical;
    }
}
