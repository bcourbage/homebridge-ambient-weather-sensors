 ...
 */
export function dataPointFromUniqueId(uniqueId) {
    if (!uniqueId) {
        return undefined;
    }
...
function inferKind(contextKind, legacyType, services) {
 ...
 */
function inferKindFromServices(services) {
...
function kindForServiceUuid(service) {
