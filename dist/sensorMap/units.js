 ...
 */
export const LEGAL_UNITS_FOR_MEASUREMENT = {
 ...
 * illuminance sensors.
 */
export const DEFAULT_SOURCE_UNIT_FOR_MEASUREMENT = {
 ...
 */
export const DEFAULT_DISPLAY_UNIT_FOR_MEASUREMENT = {
    temperature: 'fahrenheit',
    humidity: 'percent',
 ...
 */
export function isLegalUnit(measurement, unit) {
 ...
 */
export const COMPATIBLE_KINDS_FOR_MEASUREMENT = {
