...
import type { Measurement, NumericSensorRow, SensorUnit } from '../sensorMap/types.js';
 ...
 */
const DISPLAY_FORMAT: Partial<Record<SensorUnit, { decimals: number; suffix: string }>> = {
