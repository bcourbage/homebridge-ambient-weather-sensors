 ...
 */
export function sanitizeForTileName(input: string): string {
  return input
 ...
 */
export function isUserRenamed(currentName: string | undefined, lastSetName: string | undefined): boolean {
