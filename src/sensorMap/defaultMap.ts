...
const STATIC_ROWS: ReadonlyArray<DefaultSensorRow> = [
 ...
 * NOT canonical.
 */
function makeNumberedRows(): DefaultSensorRow[] {
...
export const DEFAULT_SENSOR_MAP: ReadonlyArray<DefaultSensorRow> = [
  ...STATIC_ROWS,
  ...makeNumberedRows(),
];
