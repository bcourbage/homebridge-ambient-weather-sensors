...
export const LIGHT_WM2_WRAPPER: WrapperDescriptor = {
  id: 'light-wm2',
  schemaVersion: 1,
...
export const PM25_WRAPPER: WrapperDescriptor = {
  id: 'air-quality-pm25',
  schemaVersion: 1,
  constructor: AirQualityAccessory,
};

export const PM10_WRAPPER: WrapperDescriptor = {
  id: 'air-quality-pm10',
  schemaVersion: 1,
  constructor: AirQualityAccessory,
};
 ...
 */
export const UV_INDEX_WRAPPER: WrapperDescriptor = {
  id: 'uv-index-motion',
  schemaVersion: 1,
